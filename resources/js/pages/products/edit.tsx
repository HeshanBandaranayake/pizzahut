        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6 max-w-2xl mx-auto">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-black italic tracking-tight text-[#EE1922]">EDIT PRODUCT</h2>
                        <p className="text-sm text-muted-foreground font-medium italic uppercase tracking-tighter">Modify {product.name}</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="grid gap-6">
                    ...
                    >
                        <Save className="mr-3 size-6" /> Update Product
                    </Button>
                </form>
            </div>
        </AppLayout>
